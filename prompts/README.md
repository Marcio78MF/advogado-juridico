...
variáveis entre `{{chaves}}`. **Nunca** salvar aqui prompt contendo dado real
de cliente — usar variáveis.

| Prompt | Uso |
|---|---|
| *(vazio — o primeiro prompt entra quando o Self Evolution Engine identificar um reutilizável)* | |
