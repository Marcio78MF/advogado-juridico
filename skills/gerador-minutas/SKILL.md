...
description: "This skill should be used when the user asks to 'gerar minuta', 'redigir contrato', 'criar contrato', 'minuta contratual', 'esboço de contrato', 'modelo de contrato', 'contrato de prestação', 'contrato de compra e venda' ou precisa de uma minuta contratual personalizada para revisão do advogado."
---
