---
name: "Edição cirúrgica (economia de tokens)"
description: "Retorna só blocos modificados em código, JSON, HTML, Markdown, workflows n8n e documentos jurídicos; nunca o artefato inteiro. Use em edição iterativa para reduzir tokens."
---
